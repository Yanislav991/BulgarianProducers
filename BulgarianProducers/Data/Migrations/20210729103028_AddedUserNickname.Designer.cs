...
namespace BulgarianProducers.Data.Migrations
{
    ...
    [Migration("20210729103028_AddedUserNickname")]
    partial class AddedUserNickname
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulgarianProducers.Data.Models.AgriculturalEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BulgarianProducers.Data.Models.Product", b =>
                {
                    b.HasOne("BulgarianProducers.Data.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BulgarianProducers.Data.Models.User", null)
                        .WithMany("Products")
